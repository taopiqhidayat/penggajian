...
class Akuntan extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Akuntan_model', 'akuntan');
    }

    public function index()
    {
        $data['judul'] = 'Halaman Akuntan';
        $this->load->view('templates/aknheader', $data);
        $this->load->view('akuntan/index');
    ...
    public function profil()
    {
        ...
        $this->load->view('templates/aknheader', $data);
        $this->load->view('akuntan/profil', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_profil()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('templates/aknheader', $data);
            $this->load->view('akuntan/editprofil', $data);
            $this->load->view('templates/footer');
        } else {
            $this->akuntan->editProfil();
            $this->session->set_flashdata('msg', 'Diedit');
            redirect('akuntan/profil');
        }
    }
