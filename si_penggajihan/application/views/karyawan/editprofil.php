  ...
  <div class="row">
    <div class="col-md-6 mx-auto mt-5">
      <div class="card">
        ...
        <div class="card-body">
          <form action="<?= base_url('karyawan/edit_profil') ?>" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-3">
                    <img src="<?= base_url('assets/img/') . $user['foto'] ?>" alt="karyawan" class="img-thumbnail">
                  </div>
                  <div class="col-sm-9">
            ...
            <a href="<?= base_url('karyawan/profil') ?>" class="btn btn-secondary">Kembali</a>
          </form>
        </div>
      </div>
    </div>
