  ...
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card mt-3">
        ...
        <div class="card-body">
          <form action="<?= base_url('owner/tambah'); ?>" method="post">
            ...
            <div class="form-group">
              <label for="username">Kode Karyawan / Username</label>
              <input type="text" class="form-control" name="username" id="username" placeholder="Masukkan kode karyawan / Username" value="<?= set_value('username'); ?>">
